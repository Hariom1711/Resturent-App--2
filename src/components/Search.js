    ...
    return (
        <>
            ...
            <div className="container d-flex justify-content-between align-items-center">
                ...
                <img src={zomatoLogo} style={{ width: "7rem", position: 'relative', cursor: 'pointer', marginTop: 10, borderRadius: 10, left: '2%' }} alt="" />
            ...
            <section className='items_section mt-4 container'>
                <h2 className='px-4' style={{ fontWeight: 400 }}>Resturent in Ahmedabad Open now</h2>
